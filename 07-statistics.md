...
>> P(T) = P(F) OR P(I) = 1/125 + 1/300 = 17/1500

>> We want to find the probablity that Elvis has an identical twin GIVEN he is a twin: P(I|T)

>> P(I|T) = P(I)/P(T) = (1/300)/(17/1500) = approx. 0.29
